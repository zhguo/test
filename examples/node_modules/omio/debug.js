...
if (process.env.NODE_ENV === 'development') {
	...
	options.vnode = function (vnode) {
		...
		if (attributes && attributes.ref !== void 0 && typeof attributes.ref !== 'function' && !('$$typeof' in vnode) // allow string refs when omi-compat is installed
		) {
...

		{
			...
			inspectChildren(children, function (deepChild) {
				...
				// In omi, all keys are stored as object values, i.e. being strings
	...
	try {
		var oldRender = omi.render;
		omi.render = function (vnode, parent, merge) {
			if (parent == null && merge == null) {
				...
				// if parent == merge, it doesn't reason well and would cause trouble when omi
